...
function openHtml(res) {
  res.write("<html><head><title>CHEETAH - Node.JS / RabbitMQ demo number 3</title></head><body>");
 // res.write('<link rel="stylesheet" type="text/css" href="theme.css" />');
res.write('<div align="center"><img width="400px" src="https://static.wixstatic.com/media/99e1c6_ee5196f474d6417ca79823b2308a2b7f~mv2.png/v1/fill/w_1070,h_274,al_c,usm_0.66_1.00_0.01/99e1c6_ee5196f474d6417ca79823b2308a2b7f~mv2.png" /></div>');
  res.write('<div align="center"><h1>- MY CHEETAH CHAT ROOM -</h1></div>');
}
